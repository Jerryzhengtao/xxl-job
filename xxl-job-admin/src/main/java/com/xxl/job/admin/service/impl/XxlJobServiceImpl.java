...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> update(XxlJobInfo jobInfo) {
        ...
        if (exists_jobInfo.getTriggerStatus() == 1 && !scheduleDataNotChanged) {
            try {
                LocalDateTime nextValidTime = JobScheduleHelper.generateNextValidTime(jobInfo, LocalDateTimeUtil.toLocalDateTime(System.currentTimeMillis() + JobScheduleHelper.PRE_READ_MS));
                if (nextValidTime == null) {
                    return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type") + I18nUtil.getString("system_unvalid")));
                }
                nextTriggerTime = LocalDateTimeUtil.toEpochMilli(nextValidTime);
            } catch (Exception e) {
    ...
    public ReturnT<String> start(int id) {
        ...
        try {
            LocalDateTime nextValidTime = JobScheduleHelper.generateNextValidTime(xxlJobInfo, LocalDateTimeUtil.toLocalDateTime(System.currentTimeMillis() + JobScheduleHelper.PRE_READ_MS));
            if (nextValidTime == null) {
                return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type") + I18nUtil.getString("system_unvalid")));
            }
            nextTriggerTime = LocalDateTimeUtil.toEpochMilli(nextValidTime);
